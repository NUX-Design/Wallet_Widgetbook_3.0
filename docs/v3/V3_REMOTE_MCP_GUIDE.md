...
Scope:           mcp:read
Status:          verified staging; not production-ready
```
...
- Auth0 Google development keys ใช้ได้เฉพาะ staging; production ต้องใช้ Google OAuth credentials ของโครงการเอง
