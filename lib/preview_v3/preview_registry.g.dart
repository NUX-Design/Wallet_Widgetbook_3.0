...
import 'package:mcp_test_app/widgets/v3/current_card/preview_v3_currency_card.dart'
    as p5;
import 'package:mcp_test_app/widgets/v3/header/preview_v3_header.dart' as p6;
import 'package:mcp_test_app/widgets/v3/icon/preview_v3_lucide_icon.dart' as p7;
...
import 'package:mcp_test_app/widgets/v3/navigation/preview_v3_navigation.dart'
    as p9;
import 'package:mcp_test_app/widgets/v3/notification/preview_v3_notifications.dart'
    as p10;
import 'package:mcp_test_app/widgets/v3/profile_header/preview_v3_profile_header.dart'
    as p11;
import 'package:mcp_test_app/widgets/v3/receipt/preview_v3_receipt.dart' as p12;
...
final List<V3PreviewDefinition> generatedV3PreviewEntries = [
  V3PreviewDefinition(
    category: 'button',
    widgetName: 'V3DefaultButton',
    builder: (context) => const p0.V3DefaultButtonPreview(),
  ),
  V3PreviewDefinition(
    category: 'button',
    widgetName: 'V3MediumButton',
    builder: (context) => const p1.V3MediumButtonPreview(),
  ),
  V3PreviewDefinition(
    category: 'button',
    widgetName: 'V3MiniButton',
    builder: (context) => const p2.V3MiniButtonPreview(),
  ),
  V3PreviewDefinition(
    category: 'button',
    widgetName: 'V3SmallButton',
  ...
  V3PreviewDefinition(
    ...
    widgetName: 'V3CurrencyCard',
    builder: (context) => const p5.V3CurrencyCardPreview(),
  ),
  V3PreviewDefinition(
    category: 'header',
    widgetName: 'V3Header',
    builder: (context) => const p6.V3HeaderPreview(),
  ),
  V3PreviewDefinition(
    category: 'icon',
    widgetName: 'V3LucideIcon',
    builder: (context) => const p7.V3LucideIconPreview(),
  ),
  V3PreviewDefinition(
    category: 'icon_button',
    widgetName: 'V3IconButton',
    builder: (context) => const p8.V3IconButtonPreview(),
  ),
  V3PreviewDefinition(
    category: 'navigation',
    widgetName: 'V3Navigation',
    builder: (context) => const p9.V3NavigationPreview(),
  ),
  V3PreviewDefinition(
    category: 'notification',
    widgetName: 'V3Notifications',
    builder: (context) => const p10.V3NotificationsPreview(),
  ),
  V3PreviewDefinition(
    category: 'profile_header',
    widgetName: 'V3ProfileHeader',
    builder: (context) => const p11.V3ProfileHeaderPreview(),
  ),
  V3PreviewDefinition(
    category: 'receipt',
    widgetName: 'V3Receipt',
    builder: (context) => const p12.V3ReceiptPreview(),
  ),
  V3PreviewDefinition(
    category: 'receipt',
    widgetName: 'V3TransactionSuccess',
    builder: (context) => const p13.V3TransactionSuccessPreview(),
  ),
  V3PreviewDefinition(
    category: 'splash',
    widgetName: 'V3SplashAnimation',
    builder: (context) => const p14.V3SplashAnimationPreview(),
  ),
];
